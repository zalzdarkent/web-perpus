...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO buku (nama, isbn, unit) VALUES ('$nama_buku', '$isbn', '$unit')";
...
<body>
    <div class="container d-flex justify-content-center">
        <div class="card w-100">
            <div class="card-body">
                <h1 class="card-title text-center my-4">Tambah Buku</h1>
                <form action="" method="post">
                    <div class="mb-3">
                        <label for="namaBuku" class="form-label">Nama Buku</label>
                        <input type="text" name="nama" class="form-control" id="namaBuku" required>
                    </div>
                    <div class="mb-3">
                        <label for="isbnBuku" class="form-label">ISBN</label>
                        <input type="number" name="isbn" class="form-control" id="isbnBuku" required>
                    </div>
                    <div class="mb-3">
                        <label for="unitBuku" class="form-label">Unit</label>
                        <input type="number" name="unit" class="form-control" id="unitBuku" required>
                    </div>
