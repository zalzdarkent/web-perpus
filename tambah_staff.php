...
<body>
    <div class="container d-flex justify-content-center">
        <div class="card w-100">
            <div class="card-body">
                <h1 class="card-title text-center my-4">Tambah Staff</h1>
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="telp" class="form-control" id="isbnBuku" required>
                    </div>
                    <div class="mb-3">
                        <label for="unitBuku" class="form-label">Email</label>
                        <input type="email" name="email" class="form-control" id="unitBuku" required>
                    </div>
